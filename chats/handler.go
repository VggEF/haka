...
func (h *Handler) GetUserChats(c *gin.Context) {
	...
	chats, err := h.service.GetUserChats(userID.(int))
	if err != nil {
...
func (h *Handler) CreatePrivateChat(c *gin.Context) {
	...
	chat, err := h.service.CreatePrivateChat(userID.(int), otherUserID)
	if err != nil {
		c.JSON(http.StatusInternalServerError, gin.H{"error": err.Error()})
		return
	}
...
func (h *Handler) CreateGroupChat(c *gin.Context) {
	...
	chat, err := h.service.CreateGroupChat(&req, userID.(int))
	if err != nil {
		c.JSON(http.StatusInternalServerError, gin.H{"error": err.Error()})
		return
	}
...
func (h *Handler) LeaveChat(c *gin.Context) {
	...
	if err := h.service.LeaveChat(chatID, userID.(int)); err != nil {
		c.JSON(http.StatusInternalServerError, gin.H{"error": err.Error()})
		return
	}
...
func (h *Handler) GetMessages(c *gin.Context) {
	...
	messages, err := h.service.GetMessages(chatID, userID.(int), &query)
	if err != nil {
		c.JSON(http.StatusInternalServerError, gin.H{"error": err.Error()})
		return
	}
...
func (h *Handler) SendMessage(c *gin.Context) {
	...
	message, err := h.service.SendMessage(chatID, userID.(int), &req)
	if err != nil {
		c.JSON(http.StatusInternalServerError, gin.H{"error": err.Error()})
		return
	}
...
func (h *Handler) MarkAsRead(c *gin.Context) {
	...
	if err := h.service.MarkMessageAsRead(messageID, userID.(int)); err != nil {
		c.JSON(http.StatusInternalServerError, gin.H{"error": err.Error()})
		return
	}

	c.JSON(http.StatusOK, gin.H{"message": "сообщение отмечено как прочитанное"})
}
...
func (h *Handler) DeleteMessage(c *gin.Context) {
	...
	if err := h.service.DeleteMessage(messageID, userID.(int)); err != nil {
		c.JSON(http.StatusInternalServerError, gin.H{"error": err.Error()})
		return
	}
